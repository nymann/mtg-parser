...
```text
crates/mtg-grammar/src/grammar.pest        loc=1490  surface-count=372
crates/mtg-grammar/src/ast.rs              loc=1382  surface-count=46
crates/mtg-grammar/src/parse.rs            loc=3583  surface-count=155
crates/mtg-grammar/src/unparse.rs          loc=2275  surface-count=84
```
...
a1a382b Refactor grammar-core hotspot iteration 4
f158b53 Refactor grammar-core hotspot iteration 3
62df902 Refactor grammar-core hotspot iteration 2
ab85c12 TUI complexity sparkline strip
3b0ab18 Refactor grammar-core hotspot iteration 1
4ef2863 Add grind meta-loop: refactor until quiet, then add-card
e26528b Capture gate output for TUI stability
13b965d Refactor grammar-core hotspot iteration 1
86c2d45 Support mouse wheel scrolling in TUI
f275174 Refactor destroy target permanent grammar
128a0e5 Reuse TUI for refactor hotspot workflow
```
