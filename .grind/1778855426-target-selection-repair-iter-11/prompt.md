...
```text
crates/mtg-grammar/src/grammar.pest        loc=1517  surface-count=405
crates/mtg-grammar/src/ast.rs              loc=1539  surface-count=56
crates/mtg-grammar/src/parse.rs            loc=3714  surface-count=172
crates/mtg-grammar/src/unparse.rs          loc=2389  surface-count=100
```
