...
impl KeywordAbility {
    ...
    pub const SHADOW: Self = Self::Named(NamedKeywordAbility::Shadow);
...
impl From<KeywordAbility> for KeywordSerde {
    fn from(keyword: KeywordAbility) -> Self {
        match keyword {
            ...
            KeywordAbility::Named(NamedKeywordAbility::Shadow) => Self::Shadow,
...
impl From<KeywordSerde> for KeywordAbility {
    fn from(keyword: KeywordSerde) -> Self {
        match keyword {
            ...
            KeywordSerde::Shadow => Self::Named(NamedKeywordAbility::Shadow),
