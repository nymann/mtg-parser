...
pub use ast::{
    ...
    CounterTargetSpellCondition, CreatureStatus, CreatureType, DamageAmount, DamageAssignment,
    DamageAssignmentGroup, DamageEvent, DamageKind, DamageLifeGainCap, DamageLifeGainReference,
    DamagePrevention, DamagePreventionAmount, DamagePreventionDuration, DamagePreventionEffect,
